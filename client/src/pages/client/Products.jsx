...
const Products = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 min-h-screen py-4 sm:py-6">
      ...
      {isDrawerOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          />
          {/* Drawer content */}
          <div className="relative w-72 max-w-[85%] bg-white h-full shadow-xl overflow-y-auto p-5 animate-slide-in-left">
                      ...
                      <div className="mt-1.5 sm:mt-2">
                        ...
                        <Link to="/checkout" state={{ product: item }} className="block">
                          <button
                            ...
                            className="w-full h-7 sm:h-8 rounded-md bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 disabled:cursor-not-allowed text-white text-[11px] sm:text-xs font-semibold transition"
                          >
